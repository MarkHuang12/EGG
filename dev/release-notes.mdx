...
<Update label="restaking@0.7.0" tags={["Solana Mainnet"]} description="August 5, 2025">
    ## Liquid Restaking Program v0.7.0 Released

    ### Fund Implementation
    - The full fund cash-in/out cycle is now fully implemented.
    - The reward harvesting and distribution process is complete and live.
    - The reward module has been updated to prevent potential DoS scenarios caused by dormant user accounts.

    ### Restaking Protocol Integration
    - Integrated the **SolvBTC Vault Program** for **fragBTC**.

    ### Protocol Roadmap
    - Additional (re)staking protocol integrations are planned to enhance future product capabilities.
    - With all major technical milestones complete, the protocol is now considered mature.
      The next step is the **governance transition of protocol authority** to the governance token, after which the protocol will be open-sourced.

    ### References
    - [@fragmetric-labs/sdk](https://www.npmjs.com/package/@fragmetric-labs/sdk)

    ### Latest Audit Reports
    - [QuantStamp Audit – August 2025](https://fragmetric-assets.s3.ap-northeast-2.amazonaws.com/audit-25-08-quantstamp.pdf)
    - [Certora Audit – July 2025](https://fragmetric-assets.s3.ap-northeast-2.amazonaws.com/audit-25-07-certora.pdf)
</Update>
