...
<Info>
  Creating pools and vaults in DeFi is permissionless, but Fragmetric's initial whitelist includes only Orca, Kamino, Exponent, RateX, NX Finance, Banx, Loopscale, and Sandglass with **F Points rewards exclusive to these platforms**. As liquidity deepens and stabilizes, the whitelist will expand.
</Info>
