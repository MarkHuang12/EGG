...
<Info>
  Creating pools and vaults in DeFi is permissionless, but Fragmetric's initial whitelist includes only Orca, Kamino, Exponent, RateX, NX Finance, and Banx with **F Points rewards exclusive to these platforms**. As liquidity deepens and stabilizes, the whitelist will expand.
</Info>
...
<Tabs>
  <Tab title="Overview">
    ...
    | 15     | Looping       | wfragSOL         | NX Finance            | [Link](https://www.nxfinance.info/leverage/v2/fragSOL)                                    | 3              |
    | 16     | Looping       | wfragSOL         | Banx                  | [Link](https://banx.gg/multiply/wfragSOL)                                                 | 3              |
  </Tab>
  <Tab title="Orca">
