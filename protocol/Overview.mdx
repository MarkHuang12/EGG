...
### **Develop a secure standard for Liquid Restaking Tokens (LRTs)**
...
### **Delegate user’s deposit to the secure and profitable Restaking Protocol, NCN/AVS**
...
### **Contribute to the growth of Solana’s restaking ecosystem with SANG**
