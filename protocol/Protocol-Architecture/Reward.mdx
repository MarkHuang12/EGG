...
* **Contribution Growth**: Contributions grow linearly based on two factors:
...
$$ \text\{User's Contribution} = \int\_\{t\_\{\text\{start}}}^\{t\_\{\text\{end}}} \text\{Amount of } \\$\text\{fragSOL held at time } t \\, dt $$
