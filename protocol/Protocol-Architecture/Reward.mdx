...
\text\{User's Reward During Block} =

\text\{Total Reward Amount During Block} \times

\left(

\frac\{\text\{User's Contribution During Block}}\{\text\{Total Pool Contribution During Block}}
