...
The Fund is the primary module responsible for managing user assets within the Fragmetric ecosystem. It accepts deposits of SOL, LSTs, and other supported assets, and mints the corresponding fragAsset. The minting process leverages pricing data from the Normalized Token Pool (covered in the next section). In addition, the Fund manages withdrawal requests by reserving adequate liquidity and executing these requests periodically, allowing users to claim their assets in a timely manner.
...
1. **Deposits**: Users deposit SOL or supported LSTs into the Fund.
