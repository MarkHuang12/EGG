...
<Info>
  Rewards within the protocol are distributed in two ways: When NCN/AVS rewards are distributed in tokens that can be deposited back into fragSOL, the protocol uses auto-compounding to increase fragSOL’s APY.&#x20;
