...
description: "Maximize yield through (re)staking with fragAsset"
---
...
<Tabs>
  <Tab title="(Re)stake">
    ...
    <Steps>
      <Step title="Head to app.fragmetric.xyz/restake">
        <Frame>
          ![](/src/assets/images/restaking_1.png)
        </Frame>
      </Step>
      <Step title="Connect Wallet to Fragmetric">
        ...
        <Frame>
          ![](/src/assets/images/restaking_2.png)
        </Frame>
      </Step>
      <Step title="Select the token you wish to restake">
        ...
        <Frame>
          ![](/src/assets/images/restaking_4.png)
        </Frame>
      </Step>
      <Step title="Choose Asset to (re)stake as fragSOL">
        ...
        <Frame>
          ![](/src/assets/images/restaking_5.png)
        </Frame>
      </Step>
      <Step title="Choose Amount to (re)stake as fragSOL">
        ...
        <Frame>
          ![](/src/assets/images/restaking_6.png)
        </Frame>
      </Step>
      <Step title="Click RESTAKE button">
        ...
        <Frame>
          ![](/src/assets/images/restaking_7.png)
        </Frame>
      </Step>
      <Step title="Wait for the transaction to be submitted">
        ...
        <Frame>
          ![](/src/assets/images/restaking_8.png)
        </Frame>
      </Step>
  ...
  <Tab title="Unstake">
    ...
    Once you submit an unstake request, it will be placed in a queue and become claimable after 3 epochs (up to approximately 6 days). During this period, Fragmetric handles the following on your behalf:
    ...
    <Steps>
      <Step title="Head to app.fragmetric.xyz/unstake">
        <Frame>
          ![](/src/assets/images/unstake_1.png)
        </Frame>
      </Step>
      <Step title="Enter an Amount">
        ...
        <Frame>
          ![](/src/assets/images/unstake_2.png)
        </Frame>
      </Step>
      <Step title="Wait until it becomes claimable">
        ...
        <Frame>
          ![](/src/assets/images/unstake_3.png)
        </Frame>
      </Step>
    </Steps>
